                                    ...
                                    <div class="animated" data-start="fadeInUp">
                                        <div class="pt-3">
                                            <a href="{{ $slider->slider_url != '' ? $slider->slider_url : '#' }}"
                                                target="_blank" class="btn btn-outline-warning">Buy now</a>
                                            <a href="#" target="_blank" class="btn btn-outline-light"> Get first
                                                discount</a>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="caption">
                                    <div class="promo text-center">
                                        ...
                                        <div class="animated" data-start="fadeInUp">
                                            <a href="{{ $slider->slider_url != '' ? $slider->slider_url : '#' }}"
                                                target="_blank" class="btn btn-light">By now</a>
                                            <a href="#" target="_blank" class="btn btn-outline-light"> Get first
                                                discount</a>
                                        </div>
                                    </div>
    ...
    <section class="blog blog-block">
        ...
        <header>
            <div class="container">
                ...
                <div class="text">
                    <p>We just keep things minimal. <a href="{{ route('categories.index') }}" class="btn btn-main">View
                            more</a></p>
                </div>
            </div>
        </header>
                                ...
                                <a href="{{ route('categories.show', $cate->category_slug) }}">
                                    ...
                                    <div class="show-more">
                                        <a href="{{ route('categories.show', $cate->category_slug) }}"><span
                                                class="btn btn-clean">Shop now</span></a>
                                    </div>
                                </a>
                            </article>
                        </div>
    ...
    <section class="products">
        ...
        <header>
            <div class="container">
                ...
                <div class="text">
                    <p>
                        Find your perfectmatch <a href="{{ route('product.index') }}" class="btn btn-main">View all</a>
                    </p>
                </div>
            </div>
        </header>
    ...
    <section class="blog blog-widget blog-animated">
        ...
        <header>
            <div class="container">
                ...
                <div class="text">
                    <p>
                        Explore and unfold thoughts <a href="{{ route('blog.index') }}" class="btn btn-main">View
                            all</a>
                    </p>
                </div>
            </div>
                    ...
                    <figure>
                        ...
                        <figcaption>
                            <span>
                                ...
                                <small>We shipping all over the world</small>
                            </span>
                        </figcaption>
                    </figure>
                </div>
