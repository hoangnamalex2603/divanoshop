                    ...
                    <div class="navigation navigation-main">
                        ...
                        <div class="floating-menu">
                            ...
                            <ul>
                                            ...
                                            <div class="box-full">
                                                <div class="box clearfix">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('categories.index') }}">Product
                                                                categories</a></li>
                                                        <li><a href="{{ route('product.index') }}">Products grid</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a href="#">Checkout <span class="open-dropdown"><i
                                                class="fa fa-angle-down"></i></span></a>
                                    <div class="navbar-dropdown navbar-dropdown-single">
                                        <div class="navbar-box">
                                            <div class="box-full">
                                                <div class="box clearfix">
                                                    <ul>
                                                        ...
                                                        <li><a href="{{ route('cart.index') }}">Checkout - Cart
                                                                items</a></li>
                                                        <li><a href="{{ route('cart.create') }}">Checkout -
                                                                Delivery</a></li>
                                                        @if (Session::get('customer_cart'))
                                                            <li><a href="{{ route('pay-cart.index') }}">Checkout -
                                                                    Payment</a></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                ...
                                <li class="nav-settings">
                                    <a href="javascript:void(0);"><span class="nav-settings-value">ENG</span> <span
                                            class="open-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                    <div class="navbar-dropdown navbar-dropdown-single">
                                        <div class="navbar-box">
                                            <div class="box-full">
                        ...
                        <div class="checkout">
                            <div class="clearfix" id="CartWrapper">
                                ...
                                <div class="cart-block-buttons clearfix">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href="javascrip:void(0)" class="btn btn-outline-info continue">Continue
                                                shoppingf</a>
                                        </div>
